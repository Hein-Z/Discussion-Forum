...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/AllQuestion.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/AllQuestion.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      ...
      this.$inertia.post('/login', data).then(function (_) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onRegister: function onRegister() {
      ...
      this.$inertia.post("/register", data).then(function (_) {
        return _this.loading = false;
      })["catch"](function (err) {
        return _this.loading = false;
      });
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/CreateQuestion.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/CreateQuestion.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onCreate: function onCreate() {
      ...
      this.$inertia.post(this.route('question.store'), data).then(function (_) {
        _this.loading = false;

        _this.$toastr.s('successfully created');
      })["catch"](function (err) {
        return _this.loading = false;
      });
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onEdit: function onEdit() {
      ...
      data.append("password", this.password);
      data.append("image", this.image);
      this.$inertia.post("/profile/edit", data).then(function (_) {
        return _this.loading = false;
      })["catch"](function (err) {
        return _this.loading = false;
      });
  ...
  created: function created() {
    var _this$$page$props$aut = this.$page.props.auth_user,
        name = _this$$page$props$aut.name,
        email = _this$$page$props$aut.email;
    this.name = name;
    this.email = email;
  }
});
...
/* harmony import */ var _Layout_Pagination__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Layout/Pagination */ "./resources/js/Pages/Layout/Pagination.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    like: function like(q_id, index) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/question/like/' + q_id).then(function (res) {
        if (res.data.success) {
          _this.questions.data[index].is_like = true;
          _this.questions.data[index].like_count++;

          _this.$toastr.s(res.data.like);

          _this.$toastr.s('Liked');
        }
      });
    },
    unlike: function unlike(q_id, index) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/question/unlike/' + q_id).then(function (res) {
        console.log(res.data.success);

        if (res.data.success) {
          _this2.questions.data[index].is_like = false;
          _this2.questions.data[index].like_count--;

          _this2.$toastr.s(res.data.unlike);

          _this2.$toastr.s('Unliked');
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    },
    save: function save(index, q_id) {
      var _this3 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.save', q_id)).then(function (res) {
        if (res.data.success) {
          _this3.questions.data[index].is_save = true;

          _this3.$toastr.s('Saved');
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    },
    unsave: function unsave(index, q_id) {
      var _this4 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.unsave', q_id)).then(function (res) {
        if (res.data.success) {
          _this4.questions.data[index].is_save = false;

          _this4.$toastr.w('Unsaved');
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    ...
    fix: function fix(q_id, index) {
      var _this5 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.fix', q_id)).then(function (res) {
        if (res.data.success) {
          _this5.questions.data[index].isFixed = 'true';
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    },
    unfix: function unfix(q_id, index) {
      var _this6 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.unfix', q_id)).then(function (res) {
        if (res.data.success) {
          _this6.questions.data[index].isFixed = 'false';
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    },
    deleteQuestion: function deleteQuestion(index, id) {
      var _this7 = this;

      if (confirm('Are You Sure?')) {
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.delete', id)).then(function (res) {
          if (res.data.success) {
            _this7.questions.data.splice(index, 1);

            _this7.$toastr.s('successfully deleted');
          }
        })["catch"](function (e) {
          return _this7.$toastr.e('something wrong!');
        });
      }
    }
  },
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/Master.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/Master.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/Nav.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/Nav.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/Pagination.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/Pagination.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/SideBar.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/SideBar.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/QuestionDetail.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/QuestionDetail.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    like: function like(q_id) {
      var _this = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/question/like/' + q_id).then(function (res) {
        if (res.data.success) {
          _this.question.is_like = true;
          _this.question.like_count++;

          _this.$toastr.s('Liked');
        }
      });
    },
    unlike: function unlike(q_id) {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/question/unlike/' + q_id).then(function (res) {
        if (res.data.success) {
          _this2.question.is_like = false;
          _this2.question.like_count--;

          _this2.$toastr.w('Unliked');
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    },
    save: function save(q_id) {
      var _this3 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.save', q_id)).then(function (res) {
        if (res.data.success) {
          _this3.question.is_save = true;
    ...
    unsave: function unsave(q_id) {
      var _this4 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.unsave', q_id)).then(function (res) {
        if (res.data.success) {
          _this4.question.is_save = false;
    ...
    createComment: function createComment(q_id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/question/comment/send', data).then(function (res) {
        ...
        if (success) {
          ...
          _this5.question.comments.push(comment);
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    ...
    fix: function fix(q_id) {
      var _this6 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.fix', q_id)).then(function (res) {
        if (res.data.success) {
          _this6.question.isFixed = 'true';
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    },
    unfix: function unfix(q_id) {
      var _this7 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.unfix', q_id)).then(function (res) {
        if (res.data.success) {
          _this7.question.isFixed = 'false';
        }
      })["catch"](function (err) {
        return console.log(err);
      });
    ...
    deleteQuestion: function deleteQuestion(id) {
      ...
      if (confirm('Are You Sure?')) {
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.delete', id)).then(function (res) {
          if (res.data.success) {
            _this8.$toastr.s('successfully deleted');

            window.location.href = "/";
          }
        })["catch"](function (e) {
          return _this8.$toastr.e('something wrong!');
        });
      }
    }
  },
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/UserQuestion.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/UserQuestion.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    deleteQuestion: function deleteQuestion(index, id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.route('question.delete', id)).then(function (res) {
        if (res.data.success) {
          _this.questions.data.splice(index, 1);

          _this.$toastr.s('successfully deleted');
        }
      })["catch"](function (e) {
        return _this.$toastr.e('something wrong!');
      });
    }
  },
  created: function created() {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/AllQuestion.vue?vue&type=template&id=3f09160e&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/AllQuestion.vue?vue&type=template&id=3f09160e& ***!
  \*********************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "card mt-5 col-md-4 offset-4" }, [
        ...
        _c(
          ...
          [
            ...
            _c("small", { staticClass: "text-danger text-center" }, [
              _vm._v(" " + _vm._s(_vm.$page.props.flash.error))
            ]),
            _vm._v(" "),
            _c(
              "button",
              ...
              [
                ...
                _vm._v(
                  "\n                    " +
                    _vm._s(_vm.loading ? "Wait..." : "Submit") +
                    "\n                "
                )
              ]
            )
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "card mt-5 col-md-4 offset-4" }, [
      _c("div", { staticClass: "card-header" }, [_vm._v("Register Form")]),
      _vm._v(" "),
      _c("div", { staticClass: "card-body" }, [
        _c(
          "form",
          ...
          [
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("input", {
                ...
                staticClass: "form-control",
                attrs: { type: "name", name: "name", id: "name" },
            ...
            _vm._v(" "),
            _c("div", { staticClass: "form-group" }, [
              _c("label", { attrs: { for: "image" } }, [_vm._v("Avatar")]),
              _vm._v(" "),
              _c("input", {
                staticClass: "form-control",
            ...
            _c(
              ...
              [
                ...
                _vm._v(
                  "\n                    " +
                    _vm._s(_vm.loading ? "Wait..." : "Register") +
                    "\n                "
                )
              ]
            )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/CreateQuestion.vue?vue&type=template&id=237be9eb&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/CreateQuestion.vue?vue&type=template&id=237be9eb& ***!
  \************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        _c(
          ...
          [
            ...
            _vm._l(_vm.$page.props.tag, function(t) {
              return _c(
                ...
                [
                  ...
                  _c(
                    "label",
                    { staticClass: "form-check-label", attrs: { for: t.id } },
                    [
                      _vm._v(
                        "\n                        " +
                          _vm._s(t.name) +
            ...
            _c(
              "button",
              {
                staticClass: "btn float-right mt-3 btn-success",
                attrs: { type: "submit", disabled: _vm.loading }
              },
              [
                _c("span", {
  ...
  return _c("Master", [
    _c("div", { staticClass: "card" }, [
      _c(
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.$page.props.flash.success,
              expression: "$page.props.flash.success"
            }
          ],
        ...
        [
          _c("strong", [_vm._v(_vm._s(_vm.$page.props.flash.success))]),
          _vm._v(" "),
          _c(
            "button",
            {
      ...
      _c("div", { staticClass: "card-body" }, [
        _c(
          ...
          [
            _c("div", { staticClass: "form-group" }, [
              _c("label", { attrs: { for: "name" } }, [_vm._v("Nammastere")]),
              _vm._v(" "),
              _c("input", {
                directives: [
                  {
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("img", {
                attrs: {
                  src: _vm.$page.props.auth_user.image,
                  width: "70px",
                  alt: _vm.$page.props.auth_user.image
                }
              }),
              _vm._v(" "),
              _c("input", {
              ...
              _c("small", { staticClass: "text-danger" }, [
                _vm._v(
                  _vm._s(_vm.image && _vm.errors.image ? _vm.errors.image : "")
                )
              ])
            ]),
            _vm._v(" "),
  ...
  return _c(
    ...
    [
      _vm._l(_vm.questions.data, function(q, index) {
        return _c(
          "div",
          { key: q.id, staticClass: "card promoting-card mb-2" },
          [
            _c(
              "div",
              {
                staticClass: "card-header d-flex flex-row ",
                staticStyle: { "background-color": "#4a5568" }
              },
              [
                _c("img", {
                ...
                _c("div", [
                  _c(
                    ...
                    {
                      staticClass:
                        "card-title text-success font-weight-bold h6 my-2"
                    },
                    [_vm._v(_vm._s(q.user.name))]
                  ),
                  _vm._v(" "),
                  _c("p", { staticClass: "card-text" }, [
                    _c("i", { staticClass: "far fa-clock pr-2" }),
                    _vm._v(_vm._s(q.date))
                  ]),
                  _vm._v(" "),
                  _c(
                    "h4",
                    { staticClass: "card-title font-weight-bold mb-2" },
                  ...
                  _c("div", { staticClass: "d-flex flex-row" }, [
                    ...
                    _c(
                      ...
                      _vm._l(q.tags, function(tag) {
                        return _c(
                          "inertia-link",
                          {
                            key: tag.id,
                            staticClass: "ml-2 badge badge-dark",
              ...
              _c(
                ...
                [
                  _c("p", { staticClass: "card-text text-dark" }, [
                    _vm._v(_vm._s(q.description))
                  ]),
                  _vm._v(" "),
                  _c(
                    "inertia-link",
                    {
                      staticClass: "btn text-success p-2 px-4",
                      attrs: {
                        href: _vm.route("question.detail", [q.slug, q.id])
                      }
                    },
                    [
                      _vm._v(
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "float-right p-1 mt-3 mr-3 text-muted h5 text-warning"
                    },
                    [_vm._v(_vm._s(q.comments.length))]
                  ),
                  _vm._v(" "),
                  _c("h5", { staticStyle: { display: "inline" } }, [
                    _c("i", {
                      staticClass:
                        "far fa-comment float-right p-1 mt-3 h5 text-muted text-primary"
                    })
                  ]),
                  _vm._v(" "),
                  _c(
                      ...
                      directives: [
                        {
                          ...
                          rawName: "v-show",
                          value: !q.is_like,
                          expression: "!q.is_like"
                        }
                      ],
                      staticStyle: { display: "inline" },
                      on: {
                        click: function($event) {
                          return _vm.like(q.id, index)
                        }
                      }
                    },
                    [
                      _c("i", {
                        staticClass:
                          "far fa-heart  float-right p-1 mt-3  text-danger"
                      })
                    ]
                  ),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c("i", {
                        staticClass:
                          "fas fa-heart float-right p-1 mt-3 text-primary"
                      })
                    ]
                  ),
                  _vm._v(" "),
                  q.is_save === false
                    ? _c("i", {
                        staticClass:
                          "far fa-star float-right p-1 mt-3 mr-3   text-warning",
                        on: {
                          click: function($event) {
                            return _vm.save(index, q.id)
                          }
                        }
                      })
                    : _vm._e(),
                  ...
                  q.is_save === true
                    ? _c("i", {
                        staticClass:
                          "fas fa-star float-right p-1 mt-3 mr-3   text-warning",
                        on: {
                          click: function($event) {
                            return _vm.unsave(index, q.id)
                          }
                        }
                      })
                    : _vm._e()
      ...
      _c("Pagination", {
        ...
        attrs: { links: _vm.questions.links }
      })
    ],
    2
  )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/Master.vue?vue&type=template&id=91f0c2a4&":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/Master.vue?vue&type=template&id=91f0c2a4& ***!
  \***********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/Nav.vue?vue&type=template&id=7f1127f2&":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/Nav.vue?vue&type=template&id=7f1127f2& ***!
  \********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "mb-1 navbar navbar-expand-lg navbar-dark sticky-top default-color"
    },
    [
      _c(
        "inertia-link",
      ...
      _c(
        "div",
        {
          ...
          attrs: { id: "navbarSupportedContent-333" }
        },
        [
          _c("ul", { staticClass: "navbar-nav mr-auto" }, [
            ...
            _c(
              ...
              [
                _c(
                  ...
                  {
                    staticClass: "nav-link",
                    attrs: { href: "/?type=answered" }
                  },
                  [_vm._v("Answered Question")]
                )
              ],
              1
            ),
            ...
            _c(
              ...
              [
                _c(
                  "inertia-link",
                  { staticClass: "nav-link", attrs: { href: "/?type=saved" } },
                  [_vm._v("Saved Question")]
                )
              ],
              1
            )
            ...
            _c("li", { staticClass: "nav-item dropdown" }, [
              ...
              _c(
                "div",
                {
                  ...
                  attrs: { "aria-labelledby": "navbarDropdownMenuLink-333" }
                },
                [
                  _c(
                    "inertia-link",
                    {
                      ...
                      attrs: { href: _vm.route("user.question") }
                    },
                    [
                      _vm._v(
                        "Welcome\n                        " +
                          _vm._s(_vm.$page.props.auth_user.name) +
                          "\n                    "
                      )
                    ]
                  ),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("li", { staticClass: "nav-item" }, [
      _c("a", { staticClass: "nav-link waves-effect waves-light" }, [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/Pagination.vue?vue&type=template&id=315c5434&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/Pagination.vue?vue&type=template&id=315c5434& ***!
  \***************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.links.length !== 0
    ? _c(
        "nav",
        {
          attrs: {
            "aria-label": "Page navigation example justify-content-between"
          }
        },
        [
          _c(
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/Layout/SideBar.vue?vue&type=template&id=2e80dba0&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/Layout/SideBar.vue?vue&type=template&id=2e80dba0& ***!
  \************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: !_vm.isProfileUrl,
            expression: "!isProfileUrl"
          }
        ],
        ...
        _c(
          ...
          [
            _c(
              ...
              {
                staticClass:
                  "list-group-item list-group-item-action bg-success",
                attrs: { href: _vm.route("question.create") }
              },
              [_vm._v("\n                Ask New Question\n            ")]
            ),
            _vm._v(" "),
            _c(
              ...
              {
                staticClass:
                  "mb-0  list-group-item list-group-item-action text-center ",
                attrs: { href: _vm.route("home") }
              },
              [_vm._v("All\n                Tags")]
            ),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/QuestionDetail.vue?vue&type=template&id=6abd2e40&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/QuestionDetail.vue?vue&type=template&id=6abd2e40& ***!
  \************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("Master", [
    _c("div", [
      _c("div", { staticClass: "card promoting-card mb-4" }, [
        _c(
          "div",
          {
            staticClass: "card-header d-flex flex-row ",
          ...
          [
            ...
            _c("div", [
              ...
              _c("p", { staticClass: "card-text" }, [
                _c("i", { staticClass: "far fa-clock pr-2" }),
                _vm._v(_vm._s(_vm.question.date))
              ]),
              _vm._v(" "),
              _c("h4", { staticClass: "card-title font-weight-bold mb-2" }, [
                _vm._v(_vm._s(_vm.question.title))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "d-flex flex-row" }, [
                _vm.question.isFixed == "false"
                  ? _c("small", { staticClass: "text-danger" }, [
                      _vm._v("Need Fixed")
                    ])
                  : _vm._e(),
                ...
                _c(
                  ...
                  _vm._l(_vm.question.tags, function(tag) {
                    return _c(
                      "small",
                      { key: tag.id, staticClass: "ml-2 badge badge-dark" },
            ...
            _vm._v(" "),
            _vm.isOwn(_vm.question.user_id)
              ? _c("div", { staticClass: "ml-auto mr-0" }, [
                  _vm.question.isFixed == "false"
                    ? _c(
                        "button",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.fix(_vm.question.id)
                            }
                          }
                        },
                        [_vm._v("Fixed\n                    ")]
                  ...
                  _vm.question.isFixed == "true"
                    ? _c(
                        "button",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.unfix(_vm.question.id)
                            }
                          }
                        },
                        [_vm._v("Unfixed\n                    ")]
                  ...
                  _c(
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          return _vm.deleteQuestion(_vm.question.id)
                        }
                      }
                    },
                    [_vm._v("Delete")]
        ...
        _c("div", { staticClass: "card-body pt-0" }, [
          _c("div", { staticClass: "collapse-content" }, [
            ...
            _c(
              "small",
              { staticClass: "float-right p-1 mt-3 mr-3   text-warning" },
              [_vm._v(_vm._s(_vm.question.comments.length))]
            ),
            _c("i", {
              staticClass: "far fa-comment float-right p-1 mt-3   text-primary"
            }),
            _vm._v(" "),
            _c(
              "small",
              { staticClass: "float-right p-1 mt-3 mr-3   text-warning" },
              [_vm._v(_vm._s(_vm.question.like_count))]
            ),
            _c("i", {
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: !_vm.question.is_like,
                  expression: "!question.is_like"
                }
              ],
              staticClass:
                "far fa-heart text-muted float-right p-1 mt-3  text-danger",
              on: {
                click: function($event) {
                  return _vm.like(_vm.question.id)
                }
              }
            }),
            _vm._v(" "),
            _c("i", {
              ...
              staticClass: "fas fa-heart float-right p-1 mt-3  text-primary",
              on: {
                click: function($event) {
                  return _vm.unlike(_vm.question.id)
                }
              }
            }),
            _vm._v(" "),
            _vm.question.is_save === false
              ? _c("i", {
                  staticClass:
                    "far fa-star float-right p-1 mt-3 mr-3   text-warning",
                  on: {
                    click: function($event) {
                      return _vm.save(_vm.question.id)
                    }
                  }
                })
              : _vm._e(),
            _vm._v(" "),
            _vm.question.is_save === true
              ? _c("i", {
                  staticClass:
                    "fas fa-star float-right p-1 mt-3 mr-3   text-warning",
                  on: {
                    click: function($event) {
                      return _vm.unsave(_vm.question.id)
                    }
                  }
                })
              : _vm._e()
      ...
      _vm._v(" "),
      _vm.question.comments.length !== 0
        ? _c(
            "div",
            {
            ...
            _vm._l(_vm.question.comments, function(c) {
              return _c(
                "div",
                {
                  key: c.id,
                  staticClass: "media",
                  staticStyle: { "border-bottom": "1px dotted #ccc" }
                },
                [
                  _c("img", {
                    staticClass: "rounded-circle mb-3 mt-1 mr-3 ",
                    attrs: {
                      src: c.user.image,
                      height: "40px",
                      width: "40px",
                  ...
                  _c("div", { staticClass: "media-body" }, [
                    _c(
                      "h5",
                      {
                        staticClass: "media-heading font-weight-bold user_name"
                      },
      ...
      _c(
        "form",
        {
          ...
          on: {
            submit: function($event) {
              $event.preventDefault()
              return _vm.createComment(_vm.question.id)
            }
          }
        },
        [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/Pages/UserQuestion.vue?vue&type=template&id=6089d30c&":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/Pages/UserQuestion.vue?vue&type=template&id=6089d30c& ***!
  \**********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
      ...
      _c(
        ...
        _vm._l(_vm.questions.data, function(q, index) {
          return _c("div", { key: q.id, staticClass: "card-body" }, [
            ...
            _c(
              "div",
              { staticClass: "card-action d-inline float-right" },
              [
                _c(
                  "inertia-link",
                  {
                    staticClass: "btn btn-sm text-primary p-2 px-4",
                    attrs: {
                      href: _vm.route("question.detail", [q.slug, q.id])
                    }
                  },
...
var map = {
	"./AllQuestion": "./resources/js/Pages/AllQuestion.vue",
	"./AllQuestion.vue": "./resources/js/Pages/AllQuestion.vue",
	...
	"./CreateQuestion": "./resources/js/Pages/CreateQuestion.vue",
	"./CreateQuestion.vue": "./resources/js/Pages/CreateQuestion.vue",
	"./EditUser": "./resources/js/Pages/EditUser.vue",
